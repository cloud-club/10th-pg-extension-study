        ...
        <Table>
          ...
          <TBody>
            {([
              ...
              ['1글자 검색', <strong key="d1" className="text-ok">된다</strong>, <span key="d2" className="text-trgm">안 된다</span>, '단어면 된다'],
              ['2글자 검색', <strong key="d3" className="text-ok">된다</strong>, <span key="d4" className="text-trgm">인덱스 무력화</span>, '단어면 된다'],
