...
export default function Processes() {
  return <>
    ...
    <Section title="1. PostgreSQL 서버를 구성하는 프로세스">
...
[SQL을 보내는 client] ──접속──▶ [postmaster: 연결 접수]
    ...
    <Section title="2. 확장이 별도 프로세스를 시작하는 방법">
    ...
    <Section title="4. 예약 등록부터 실행까지의 프로세스 흐름">
    ...
    <Section title="5. 프로세스별 메모리와 공유 자원">
    ...
    <Section title="6. jobid·task·runid와 프로세스 ID의 차이">
    ...
    <Section title="7. launcher 하나가 여러 잡을 관리하는 방법">
    ...
    <Section title="8. 서버에서 프로세스 확인하기">
