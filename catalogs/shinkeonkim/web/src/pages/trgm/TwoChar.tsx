...
export default function TwoChar() {
  return (
    <>
      ...
      <EasyFirst>
        <p>
          ...
          없으면 찾아보기를 쓸 수가 없죠. 한국어는 <K>서울</K>·<K>배송</K>처럼 두 글자면 이미 낱말이라 이 함정에
          자주 걸립니다.
        </p>
      </EasyFirst>
    ...
    bptr->pmatch = true;   /* 부분 일치로 전환 */
      ...
      <Section id="why-bigm" title="3. 왜 pg_bigm 만 부분 일치로 전환할 수 있나">
      ...
      <Section id="rescue" title="4. 그런데 pg_trgm 도 패딩을 얻어내면 산다">
        <p>
        ...
        <Callout kind="ok" title="실무 처방">
          <p>
            ...
            그 대가를 실제로 잰 것이 <Link to="/foundations/whitespace">공백과 구두점 §3</Link> 이다(250행 → 203행).
          </p>
        </Callout>
      </Section>

      <Section id="version" title="5. 버전을 올리면 나아지나">
        <Callout kind="warn">
          <p>
