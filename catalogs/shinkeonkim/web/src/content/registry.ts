...
export const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: 'two-char', title: '2글자 함정', hint: '인덱스가 무력화되는 지점', view: lazy(() => import('@/pages/trgm/TwoChar')) },
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: 'environment', title: '환경과 이미지', hint: 'Docker 베이스 · CVE', view: lazy(() => import('@/pages/meta/Environment')) },
    ],
  },
]
