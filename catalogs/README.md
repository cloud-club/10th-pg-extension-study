...
| [hstore](shinkeonkim/hstore.md) | 한 컬럼에 문자열 키-값 묶음을 저장하고 연산자·GIN으로 조회 - jsonb·Redis 해시와의 차이와 동시성을 실측 | 데이터 타입 · 키-값 | RDS ○ / Azure ○ / Cloud SQL ○ / Neon ○ / Supabase 확인 필요 | shinkeonkim (week04) |
